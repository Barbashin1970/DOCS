...
**Rule DSL Flow** — визуальный декларативный язык РАГРАФ для описания регламентов. Восемь типов узлов: `input`, `threshold`, `compare`, `formula`, `switch`, `output`, `sensor`, `shacl_constraint`. Хранится в `flow.json`.
