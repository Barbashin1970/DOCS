...
Короткий ответ: **АРХИ — не отдельная программа и не надстройка над чужой системой.** Это предметная настройка РАГРАФ: тот же движок, то же хранилище, тот же язык регламентов, тот же интерфейс. Отраслевого в АРХИ — около 4% кода: клиент внешней системы управления проектами, детекторы риска стройки, пять регламентов, подтипы датчиков площадки и два экрана.

| | Строк кода | Доля |
|---|---|---|
| Общая платформа РАГРАФ | ≈ 89 800 | 96% |
| Отраслевая часть АРХИ | ≈ 3 700 | 4% |
